module.exports = function(grunt, custom, options){
  var fs, lodash, modules, defaults, settings, project, config, isEnabled, key, value, merged;
  fs = require('fs');
  ...
  project = lodash.merge(defaults, settings, function(a, b){
    if (lodash.isArray(a)) {
      return a.concat(b);
    } else {
      return undefined;
