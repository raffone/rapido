...
module.exports.svgsprite = (grunt) !->
...
module.exports.livescript = (grunt) !->
...
module.exports.time = (grunt) !->
  (require 'time-grunt') grunt

module.exports.debug = (config, custom, merged) !->
  console.log 'CONFIG ------------------------------------------------------'
